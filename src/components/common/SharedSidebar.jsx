...
const SIDEBAR_BG = "linear-gradient(180deg, #164679 0%, #0f3a56 100%)";
    ...
    >
      ...
      <div
        style={{
          ...
          padding: "0 10px",
          background:
            "linear-gradient(180deg, rgba(22, 70, 121, 0.3) 0%, rgba(22, 70, 121, 0.1) 50%, transparent 100%)",
        }}
      >
        <div style={{ position: "relative" }}>
          ...
          <div
            style={{
              ...
              inset: -8,
              background:
                "radial-gradient(circle, rgba(22, 70, 121, 0.4) 0%, transparent 70%)",
              borderRadius: "50%",
              filter: "blur(8px)",
              zIndex: 0,
            }}
          ...
          <img
            ...
            style={{
              ...
              transition: "all 0.2s",
              filter:
                "brightness(0) invert(1) drop-shadow(0 2px 8px rgba(22, 70, 121, 0.5))",
              objectFit: "contain",
              zIndex: 1,
            }}
          />
